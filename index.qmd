...
I am a  fourth year PhD student at the [Oskar Morgenstern Doctoral School](https://oskar-morgenstern-doctoral-school.univie.ac.at/) at the University of Vienna.  Before coming to Vienna, I completed the [Advanced Studies Program (ASP)](https://www.ifw-kiel.de/institute/advanced-studies-program/) at the Institute for the World Economy (IfW) in Kiel.  I received my Master's degree from the Karl-Franzens University of Graz.
...
- "The Zero Lower Bound on Household Deposit Rates: Not As Binding As We Thought"
  ...
  [Preliminary Draft](Not as binding as we thought_Ulbing Philipp.pdf) \| <a data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="cursor: pointer; text-decoration: underline; color: #18BC9C;">
  Abstract
</a> <br>
...
- "Optimal Tiered Reserve Remuneration"
  ...
  [Poster](Poster_Ulbing_OptimalTiered.pdf)
  
- "The Demand for CBDC and the Role of the Government" (with [Paul Pichler](https://sites.google.com/view/papiecon)) 
